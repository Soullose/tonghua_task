...
Agv1Message agv1MessageFromJson(String str) => Agv1Message.fromJson(json.decode(str));
...
class Agv1Message with _$Agv1Message {
  ...
  factory Agv1Message.fromJson(Map<String, dynamic> json) => _$Agv1MessageFromJson(json);
}
